                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description float-right">
                                <b-button variant="success" v-b-modal.modalPembayaran v-on:click="Add">
        ...
        <b-modal id="modalPembayaran" @ok="Save">
            ...
            <form ref="form">
                <div class="form-group">
                    ...
                    <b-form-select id="id_petugas" v-model="id_petugas" :options="nama_petugas"></b-form-select>
                </div>
                <div class="form-group">
...
module.exports = {
    ...
    methods: {
        getData: function(){
            ...
            this.axios.get("/pembayaran/" + this.perPage + "/" + offset, conf)
            .then(response => {
        ...
        Save : function(){
            ...
            if(this.action === "insert"){
                ...
                this.axios.post("/pembayaran", form, conf)
                .then(response => {
                    this.$bvToast.hide("loadingToast");
                    if(this.search == ""){
                        this.getData();
                ...
                this.axios.put("/pembayaran/" + this.id, form, conf)
                .then(response => {
                    this.$bvToast.hide("loadingToast");
                    if(this.search == ""){
                        this.getData();
        ...
        Drop : function(id){
            ...
            if(confirm('Apakah anda yakin ingin menghapus data ini?')){
                this.$bvToast.show("loadingToast");
                this.axios.delete("/pembayaran" + id, conf)
                .then(response => {
                    this.getData();
                    this.$bvToast.hide("loadingToast");
                    this.message = response.data.message;
