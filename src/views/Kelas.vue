        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-title float-left"><b>Data Kelas</b></p>
        ...
        <b-modal id="modalKelas" @ok="Save">
            ...
            <form ref="form">
                <div class="form-group">
                    ...
                    id="nama_kelas" placeholder="Nama Kelas" v-model="nama_kelas">
                </div>
                <div class="form-group">
                    <label for="nama" class="col-form-label">Kompetensi Keahlian</label>
                    <input type="text" class="form-control" name="kompetensi_keahlian"
                    id="kompetensi_keahlian" placeholder="Kompetensi Keahlian" v-model="kompetensi_keahlian">
                </div>
            </form>
        </b-modal>
    </div>
