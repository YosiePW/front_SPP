                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description float-right">
                                <b-button variant="success" v-b-modal.modalSiswa v-on:click="Add"><i class="ndu ndi-plus btn-icon-prepend"></i>Tambah</b-button>
                            </p>
        ...
        <b-modal id="modalSiswa" @ok="Save">
            ...
            <form ref="form">
                <div class="form-group">
                    ...
                    <input type="text" name="nis" class="form-contol"
                    id="nis" placeholder="NIS" v-model="nis">
                </div>
                <div class="form-group">
                    <label for="nama" class="col-form-label">Nama Siswa</label>
                    <input type="text" name="nama" class="form-control"
                    id="nama" placeholder="Nama Siswa" v-model="nama">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    id="alamat" placeholder="Alamat" v-model="alamat">
                </div>
                <div class="form-group">
                    <label for="no_telp" class="col-form-label">No. Telp</label>
                    <input type="text" name="no_telp" class="form-control"
                    id="no_telp" placeholder="No. Telp" v-model="no_telp">
                </div>
                <div class="form-group">
                    <label for="tahun" class="col-form-label">SPP</label>
                    <b-form-select id="id_spp" v-model="id_spp" :options="spp"></b-form-select>
                </div>
            </form>
        </b-modal>
    </div>
...
module.exports = {
    data : function() {
        return {
            ...
            perPage: 10,
            key: "",
            fields: ["id", "nama", "nama_kelas", "alamat", "no_telp", "tahun", "Aksi"],
            nama_kelas: [],
            tahun: [],
        }
    },
